...
INSERT INTO equipment (equipment_code, equipment_name, equipment_model, equipment_type, location, status, manufacturer, production_date, installation_date, last_maintenance_date, maintenance_cycle) VALUES
    ...
    ('AGV-005', '激光导航AGV', 'NDC-800', 4, '总装车间/物流区', 1, '新松机器人', '2021-09-01', '2021-10-15', NULL, 180),
    ('CNC-100', '五轴加工中心', 'MAZAK-500', 3, '机加车间/精密区', 1, '山崎马扎克', '2019-11-30', '2020-01-10', '2023-06-15', 60),
    ('OLD-001', '液压冲床', 'YH32-300', 1, '报废设备区', 1, '北京第一机床', '2010-05-01', '2010-07-01', '2018-03-10', NULL);
